...
const VisualizarEstudiante = () => {
    ...
    const { consultEstudiante } = useEstudiante()
    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await consultEstudiante(id)
            if (!result) {
        ...
        <CCard className="shadow-sm border-0">
            <CCardBody>
                ...
                <div className="mb-3 ms-3 me-3">
                    <h1 className="text-4xl textos-esfot ">Visualizar Estudiante</h1>
                    <hr />
                    <CRow className="align-items-center">
                        <CCol md={9} className="mt-2">
                            <p className="text-muted">
                                Este módulo permite visualizar a detalle los datos del Estudiante seleccionado.
                            </p>
                        </CCol>
                ...
                <CRow className="ms-3 me-3">
                    ...
                    <CCol md={3}>
                        ...
                        <p><strong>Rol:</strong> {elementConsult.rol ? 'Estudiante' : ''}</p>
