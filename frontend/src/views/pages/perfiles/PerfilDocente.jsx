...
const PerfilDocente = () => {
    ...
    const updatePassword = async (data) => {
        try {
            ...
            await axios.put(`${import.meta.env.VITE_API_URL}/docente/update-password`, data, {
        ...
        <CCard className="shadow-sm border-0">
            <CCardBody>
                <div className="mb-3 ms-3 me-3">
                    <h1 className="text-4xl textos-esfot">Perfil Docente</h1>
                    <hr />
                ...
                <CRow className="ms-3 me-3">
                    ...
                    <CCol md={3}>
                        ...
                        <p><strong>Otra Facultad:</strong> {perfil.otherFaculty || 'No especificado'}</p>
                    </CCol>
                    ...
                    <CCol md={3}>
                        ...
                        <p><strong>Rol:</strong> {perfil.rol ? 'Docente' : ''}</p>
                    </CCol>
